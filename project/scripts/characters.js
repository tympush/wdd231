const heroUrl = 'https://superhero-search.p.rapidapi.com/api/heroes';
    ...
    async function fetchHeroes() {
        try {
            ...
            if (isIndexPage()) {
                ...
                if (Array.isArray(data)) {
                    displayHeroesWithDetails(data, 'heroGrid', 20); 
                } else if (data.results) {
    ...
    async function fetchVillains() {
        try {
            ...
            if (isIndexPage()) {
                if (Array.isArray(data)) {
                    displayVillains(data, 'villainRow', 10); 
                } else if (data.results) {
                ...
                if (Array.isArray(data)) {
                    displayVillainsWithDetails(data, 'villainGrid', 20); 
                } else if (data.results) {
